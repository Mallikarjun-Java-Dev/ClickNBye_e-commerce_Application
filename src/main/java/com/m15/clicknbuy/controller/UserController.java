...
public class UserController {
	...
	@PostMapping("/user/payment/cod")
	public String placeCodOrder(@RequestParam("address") String address, Principal principal, HttpSession session, ModelMap map) {
		return userService.placeCodOrder(address, principal, session, map);
	}
